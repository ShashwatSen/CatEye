...
askscan:
    ...
    if (!in_array($scan, array(
        ...
        goto askscan;
            ...
            if (count($array) > 0) {
                userinput("Do You Want CATEYE To Detect CMS Of The Sites? [Y/N]");
            ...
            if (strpos($srccd, "wp-content") !== false) {
                ...
                if ($wp_version != "") {
                    ...
                    $reallink = $ipsl . $ip;
                    echo $red . "Failed \n\n[!] CATEYE could not determine the WordPress version of the target!";
                    echo "\n\n";
                    echo $bold . $yellow . "[*] Scanning Complete. Press Enter To Continue OR CTRL + C To Stop\n\n";
                    trim(fgets(STDIN, 1024));
                    goto scanlist;
...
askupdate:
                ...
                echo $bold . $fgreen . "\n[i] You are already running the latest version of CATEYE. \n\n" . $cln;
                goto scanlist;
            } else {
